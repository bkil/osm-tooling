...
get_version() {
  sed -nr '
    s~.*(<hr /><div>Version: <a)( href=\"[^\"]*\">[^<>]*</a>[^<>]*)(</div>)</body></html>$~<hr/>\1 target=\"_blank\"\2 | single page application generated by <a target=\"_blank\" href=\"https://github.com/bkil/osm-tooling/blob/master/src/web/spamisi.sh\">spamisi.sh</a>\3~
    T e
    p
    :e
  ' "$@"
